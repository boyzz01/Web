...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url() ?>assets/third_party/desoslide/dist/css/jquery.desoslide.min.css">
        <link rel="stylesheet" href="<?= base_url() ?>assets/third_party/desoslide/dist/css/animate.min.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <script src="<?= base_url() ?>assets/third_party/desoslide/dist/js/jquery.desoslide.min.js"></script>
